...
class ScreenWidget extends StatelessWidget {
  ...
  static ValueNotifier<TextEditingController> input = ValueNotifier(
      TextEditingController());
  static ValueNotifier<String> ans = ValueNotifier('');
  static ValueNotifier<FocusNode> focus = ValueNotifier(FocusNode());
  static ValueNotifier<ScrollController> scrollController = ValueNotifier(
      ScrollController());
  ...
  Widget build(BuildContext context) {
    return Expanded(
        child: Container(
          ...
          child: ValueListenableBuilder(valueListenable: scrollController,
            builder: (BuildContext context, ScrollController scrollController, Widget) {
              return ValueListenableBuilder(valueListenable: focus,
